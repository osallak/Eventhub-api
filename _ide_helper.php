...
namespace Illuminate\Database\Schema {
    ...
    {
        /**
         * @see \App\Providers\DatabaseServiceProvider::boot()
         *
         * @param  mixed  $columnName
         *
         * @static
         */
        public static function upload($columnName)
        {
            return \Illuminate\Database\Schema\Blueprint::upload($columnName);
        }
         ...
         * @static
         */
        public static function dropUpload($columnName)
        {
            return \Illuminate\Database\Schema\Blueprint::dropUpload($columnName);
        }
    }
}
